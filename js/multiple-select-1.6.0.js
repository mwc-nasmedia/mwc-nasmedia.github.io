  ...
  var MultipleSelect = /*#__PURE__*/function () {
    ...
    _createClass(MultipleSelect, [{
      ...
      value: function initContainer() {
        ...
        this.$choice = $$e("\n      <button type=\"button\" class=\"form-select\"".concat(tabIndex, ">\n      <span class=\"multiselect-placeholder\">").concat(this.options.placeholder, "</span>\n      ").concat(this.options.showClear ? '<div class="icon-close"></div>' : '', "\n      <div class=\"icon-caret\"></div>\n      </button>\n    "));
        ...
        if (!this.options.keepOpen) {
          ...
          $$e(document).off(clickEvent).on(clickEvent, function (e) {
            if ($$e(e.target)[0] === _this.$choice[0] || $$e(e.target).parents('.form-select')[0] === _this.$choice[0]) {
              return;
            }
      ...
      value: function update(ignoreTrigger) {
        ...
        var html = '';
        if (sl === 0) {
          $span.addClass('multiselect-placeholder').html(this.options.placeholder);
        ...
        if (html) {
          $span.removeClass('multiselect-placeholder').html(html);
        }
